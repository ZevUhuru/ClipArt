...
${pack.license_summary || "These images are free for personal and commercial use. Attribution is appreciated — please credit clip.art with a link to https://clip.art when sharing."}
...
Audience: ${pack.audience || "General"}
Pack Goal: ${pack.pack_goal || "Creative bundle"}
