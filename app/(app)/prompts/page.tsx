      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-400">
            Browse AI-generated animation prompts tied to real images.
            Copy any prompt and use it in the{" "}
        ...
        {loading && prompts.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 py-20 text-center">
            ...
            <h2 className="text-base font-bold text-gray-900">No prompts yet</h2>
            <p className="mt-1 max-w-xs text-sm text-gray-400">
              Prompts appear here when you or other users generate AI suggestions in the Animation Studio.
            </p>
            <Link
              href="/animate"
