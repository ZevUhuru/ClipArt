      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="grid grid-cols-3 items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex col-span-2 justify-end items-center lg:order-3 lg:col-span-1">
            <Link href="/learn" className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Learn</Link>
