    ...
    <nav className="sticky top-0 z-40 bg-[#1c1c27]">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        ...
        <Link href="/" className="flex items-center">
          ...
          <img src="/logo-white.svg" className="h-8 sm:h-10" alt="clip.art" />
        </Link>
      ...
      >
        ...
        <div
          className={`absolute right-0 top-0 h-full w-72 bg-[#1c1c27] shadow-2xl transition-transform duration-300 ease-out ${menuOpen ? "translate-x-0" : "translate-x-full"}`}
        >
